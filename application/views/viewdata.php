...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                ...
                <h3>DETAILS OF : <small><?php echo $value->firstname.' '.$value->lastname; ?></small></h3>
                <?php } ?>
              </div>
  ...
  <div class="col-md-2">ID</div>
    <div class="col-md-10"><?php echo $data->id;  ?></div>
  </div>
</div>
    <div class="row">
    <div class="col-md-12">
    <div class="col-md-2">NAME</div>
    <div class="col-md-10"><?php echo $data->firstname.''.$data->lastname; ?></div>
  </div>
</div>
    <div class="row">
  <div class="col-md-12">
    <div class="col-md-2">EMAIL</div>
    <div class="col-md-10"><?php echo $data->email; ?></div>
  </div>
</div>
<div class="row">
  <div class="col-md-12">
    <div class="col-md-2">PHONE</div>
    <div class="col-md-10"><?php echo $data->phone; ?></div>
  </div>
</div>
<div class="row">
  <div class="col-md-12">
    <div class="col-md-2">ADDRESS</div>
    <div class="col-md-10"><?php echo $data->address; ?></div>
  </div>
</div>
<div class="row">
  <div class="col-md-12">
    <div class="col-md-2">USERNAME</div>
    <div class="col-md-10"><?php echo $data->username; ?></div>
  </div>
</div>
<?php } ?>
</div>
